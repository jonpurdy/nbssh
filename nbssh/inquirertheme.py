...
class Jon(Theme):
    ...
    def __init__(self):
        super(Jon, self).__init__()
        self.Question.mark_color = term.white
        self.Question.brackets_color = term.bright_magenta
        self.Question.default_color = term.white_on_magenta
        self.Checkbox.selection_color = term.bold_black_on_bright_green
        self.Checkbox.selection_icon = '❯'
        self.Checkbox.selected_icon = '◉'
        self.Checkbox.selected_color = term.magenta
        self.Checkbox.unselected_color = term.bright_magenta
        self.Checkbox.unselected_icon = '◯'
        self.List.selection_color = term.black_on_cyan
        #self.List.selection_color = term.white_on_magenta
        self.List.selection_cursor = ' '
        self.List.unselected_color = term.normal